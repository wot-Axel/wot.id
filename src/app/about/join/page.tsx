    ...
    <div className="legal-page">
      ...
      <div className="legal-section">
        ...
        <div className="section-content">
          ...
          <p>
            We welcome contributors of all skill levels. Our multi-chain architecture presents unique and interesting challenges that can help you grow as a blockchain developer.
          </p>
        </div>
      </div>
      <div className="legal-section">
